...
" normal colors {{{
call s:HI(         "Normal", s:bclr, s:lwht,     "none" )
call s:HI(         "Ignore",     "", s:lblk,     "none" )
call s:HI(        "Comment",     "", s:dwht,     "none" )
call s:HI(         "LineNr",     "", s:lblk,     "none" )
call s:HI(          "Float",     "", s:dylw,     "none" )
call s:HI(        "Include",     "", s:dmag,     "none" )
call s:HI(         "Define",     "", s:dgrn,     "none" )
call s:HI(          "Macro",     "", s:lmag,     "none" )
call s:HI(        "PreProc",     "", s:lgrn,     "none" )
call s:HI(      "PreCondit",     "", s:lmag,     "none" )
call s:HI(        "NonText",     "", s:dcyn,     "none" )
call s:HI(      "Directory",     "", s:dcyn,     "none" )
call s:HI(     "SpecialKey",     "", s:lylw,     "none" )
call s:HI(           "Type",     "", s:dcyn,     "none" )
call s:HI(         "String",     "", s:dgrn,     "none" )
call s:HI(       "Constant",     "", s:lmag,     "none" )
call s:HI(        "Special",     "", s:lgrn,     "none" )
call s:HI(    "SpecialChar",     "", s:lred,     "none" )
call s:HI(         "Number",     "", s:lcyn,     "none" )
call s:HI(     "Identifier",     "", s:lmag,     "none" )
call s:HI(    "Conditional",     "", s:lcyn,     "none" )
call s:HI(         "Repeat",     "", s:lred,     "none" )
call s:HI(      "Statement",     "", s:dblu,     "none" )
call s:HI(          "Label",     "", s:lmag,     "none" )
call s:HI(       "Operator",     "", s:dylw,     "none" )
call s:HI(        "Keyword",     "", s:lred,     "none" )
call s:HI(   "StorageClass",     "", s:lylw,     "none" )
call s:HI(      "Structure",     "", s:dmag,     "none" )
call s:HI(        "Typedef",     "", s:dcyn,     "none" )
call s:HI(       "Function",     "", s:lylw,     "none" )
call s:HI(      "Exception",     "", s:dred,     "none" )
call s:HI(     "Underlined",     "", s:dblu,     "none" )
call s:HI(          "Title",     "", s:dylw,     "none" )
call s:HI(            "Tag",     "", s:lylw,     "none" )
call s:HI(      "Delimiter",     "", s:lblu,     "none" )
call s:HI( "SpecialComment",     "", s:lred,     "none" )
call s:HI(        "Boolean",     "", s:dylw,     "none" )
call s:HI(           "Todo", "NONE", s:lred,     "none" )
call s:HI(        "MoreMsg", "NONE", s:lmag,     "none" )
call s:HI(        "ModeMsg", "NONE", s:lmag,     "none" )
call s:HI(          "Debug", "NONE", s:dred,     "none" )
call s:HI(     "MatchParen", s:dwht, s:dblk,     "none" )
call s:HI(       "ErrorMsg", "NONE", s:dred,     "none" )
call s:HI(       "WildMenu", s:lwht, s:dmag,     "none" )
call s:HI(         "Folded", s:dblk, s:dwht,     "none" )
call s:HI(         "Search", s:lwht, s:dred,     "none" )
call s:HI(      "IncSearch", s:lwht, s:dred,     "none" )
call s:HI(     "WarningMsg", s:lwht, s:dred,     "none" )
call s:HI(       "Question", s:lwht, s:lgrn,     "none" )
call s:HI(          "Pmenu", s:lwht, s:dgrn,     "none" )
call s:HI(       "PmenuSel", s:lwht, s:dred,     "none" )
call s:HI(         "Visual", s:lwht, s:lblk,     "none" )
call s:HI(     "StatusLine", s:dblk, s:dwht, "none" )
call s:HI(   "StatusLineNC", s:lblk, s:dblk,     "none" )
call s:HI(      "VertSplit", s:lblk, s:dblk,     "none" )
call s:HI(        "TabLine", s:dblk, s:dwht,     "none" )
call s:HI(    "TabLineFill",     "", s:dblk,     "none" )
call s:HI(     "TabLineSel", s:dblk, s:dwht,     "none" )
call s:HI(         "Cursor", s:lred,     "",     "none" )
...
call s:HI(     "FoldColumn", "NONE", s:lblk,     "none" )
call s:HI(     "SignColumn", "NONE",     "",     "none" )
" }}}

" vimscript colors {{{
call s:HI( "vimCommentTitle",     "", s:lgrn, "none" )
call s:HI(         "vimFold", s:lwht, s:dblk, "none" )
" }}}

" help file colors {{{
call s:HI( "helpHyperTextJump", "", s:lylw, "none" )
" }}}

" javascript colors {{{
call s:HI( "javaScriptNumber", "", s:lylw, "none" )
" }}}

" html colors {{{
call s:HI(     "htmlTag", "", s:dcyn, "none" )
call s:HI(  "htmlEndTag", "", s:dcyn, "none" )
call s:HI( "htmlTagName", "", s:lylw, "none" )
" }}}

" perl colors {{{
call s:HI(        "perlSharpBang", "", s:lgrn, "none" )
call s:HI(        "perlStatement", "", s:lmag,         "none" )
call s:HI( "perlStatementStorage", "", s:dred,         "none" )
call s:HI(         "perlVarPlain", "", s:dylw,         "none" )
call s:HI(        "perlVarPlain2", "", s:lylw,         "none" )
" }}}

" ruby colors {{{
call s:HI( "rubySharpBang", "", s:lgrn, "none" )
" }}}

" diff colors {{{
call s:HI(    "diffLine", "", s:lgrn, "none" )
call s:HI( "diffOldLine", "", s:dgrn, "none" )
call s:HI( "diffOldFile", "", s:dgrn, "none" )
call s:HI( "diffNewFile", "", s:dgrn, "none" )
call s:HI(   "diffAdded", "", s:dblu, "none" )
call s:HI( "diffRemoved", "", s:dred, "none" )
call s:HI( "diffChanged", "", s:dcyn, "none" )
" }}}
...
" syntastic colors {{{
call s:HI(   "SyntasticErrorSign", s:culc, s:lred, "none" )
call s:HI( "SyntasticWarningSign", s:culc, s:lmag, "none" )
" }}}
